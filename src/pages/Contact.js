...
const Contact = () => {
    useDocTitle('IsenGuard AI - Send us a message')
            ...
            <div id='contact' className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 ">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        {/* <h2 className="text-2xl">If you don't want to fill out this form, you can</h2> */}
                        {/* <h2 className="text-2xl">Call Us</h2>
                        <p className="text-gray-400">Tel: 2267515104</p> */}
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">Send an E-mail</h2>
                                <p className="text-gray-400">support@isenguardai.com</p>
                            </div>
